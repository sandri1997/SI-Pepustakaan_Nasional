...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="icon" href="assets/dist/img/LOGO-PERPUSNAS.png">
    <!-- Custom -->
...
<body class="hold-transition login-page" style="font-family: margin-left: auto; margin-right: auto; 'Quicksand', sans-serif;">
    <div class="login-box">
        <div class="login-logo">
            <a href="masuk"><b>PERPUSTAKAAN NASIONAL</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/LOGO-PERPUSNAS.png" height="80px" width="80px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
