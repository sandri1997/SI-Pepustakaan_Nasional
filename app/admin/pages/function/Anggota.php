...
if ($_GET['aksi'] == "tambah") {
    ...
    $sql = "INSERT INTO user(kode_user,npm,fullname,username,password,kelas,alamat,verif,role,join_date)
        VALUES('" . $kode_anggota . "','" . $npm . "','" . $fullname . "','" . $username . "','" . $password . "','" . $kelas . "','" . $alamat . "','" . $verif . "','" . $role . "','" . $join_date . "')";
    ...
    $query = "UPDATE user SET npm = '$npm', fullname = '$nama_lengkap', username = '$username', 
