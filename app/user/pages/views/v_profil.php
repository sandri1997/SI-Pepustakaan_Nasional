                ...
                <div class="box">
                    ...
                    <form action="pages/function/Profile.php?aksi=edit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>NPM <small style="color: red;">* Wajib diisi</small></label>
                                <input type="text" class="form-control" value="<?= $row['npm']; ?>" name="Npm" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="Kelas">
                                    ...
                                    <!-- Y -->
                                    <option disabled>------------------------------------------</option>
                                    <option value="Y - Administrasi Perkantoran">Y - Administrasi Perkantoran</option>
                                    <option value="Y - Farmasi">Y - Farmasi</option>
                                    <option value="Y - Perbankan">Y - Perbankan</option>
                                    <option value="Y - Rekayasa Perangkat Lunak">Y - Rekayasa Perangkat Lunak</option>
                                    <option value="Y - Tata Boga">Y - Tata Boga</option>
                                    <option value="Y - Teknik Kendaraan Ringan">Y - Teknik Kendaraan Ringan</option>
                                    <option value="Y - Teknik Komputer dan Jaringan">Y - Teknik Komputer dan Jaringan</option>
                                    <option value="Y - Teknik Sepeda Motor">Y - Teknik Sepeda Motor</option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p style="font-weight: bold;">NPM : <?= $row['npm']; ?></p>
